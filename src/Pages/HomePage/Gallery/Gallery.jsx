    ...
    <div className="md:my-32 mt-10 mb-14">
      ...
      <div className="mx-auto max-w-7xl">
        <div className="parent md:h-[800px] px-3 md:px-0">
          <div
            className="div2 w-full rounded-lg overflow-hidden"
            data-aos="flip-right"
          >
            <img
          ...
          <div
            className="div3 w-full rounded-lg overflow-hidden"
            data-aos="flip-right"
          >
            <img
              className="rounded-lg w-full h-full object-cover transform transition-all duration-300 hover:scale-110"
          ...
          <div
            className="div1 w-full rounded-lg overflow-hidden"
            data-aos="flip-left"
          >
            <img
              className="rounded-lg w-full h-full object-cover transform transition-all duration-300 hover:scale-110"
          ...
          <div
            className="div4 w-full rounded-lg overflow-hidden"
            data-aos="flip-up"
          >
            <img
              className="rounded-lg w-full h-full object-cover transform transition-all duration-300 hover:scale-110"
          ...
          <div
            className="div5 w-full rounded-lg overflow-hidden"
            data-aos="zoom-in"
          >
            <img
              className="rounded-lg w-full h-full object-cover transform transition-all duration-300 hover:scale-110"
          ...
          <div
            className="div6 w-full rounded-lg overflow-hidden"
            data-aos="zoom-in-up"
          >
            <img
              className="rounded-lg w-full h-full object-cover transform transition-all duration-300 hover:scale-110"
          ...
          <div
            className="div7 w-full rounded-lg overflow-hidden"
          ...
          <div
            className="div8 w-full rounded-lg overflow-hidden"
            data-aos="zoom-out"
          >
            <img
              className="rounded-lg w-full h-full object-cover transform transition-all duration-300 hover:scale-110"
          ...
          <div
            className="div9 w-full rounded-lg overflow-hidden"
            data-aos="flip-left"
          >
            <img
              className="rounded-lg w-full h-full object-cover transform transition-all duration-300 hover:scale-110"
